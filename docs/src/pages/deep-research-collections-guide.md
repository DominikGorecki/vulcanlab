...
For detailed information about collections, see the [Collections Guide](./collections.md).
...
- [Collections Guide](./collections.md) - Learn how to create and manage collections
- [Settings](./Settings.md) - Customize templates and research parameters
- [RAG](./RAG.md) - Understanding the underlying retrieval and generation system
