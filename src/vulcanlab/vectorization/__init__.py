...
__all__ = ["vectorize_chunks", "get_eligible_chunks_count", "VectorizationResult", "DEFAULT_BATCH_SIZE"]


def __getattr__(name: str):
    """Lazy import of vectorization components."""
    if name in ("vectorize_chunks", "get_eligible_chunks_count", "VectorizationResult", "DEFAULT_BATCH_SIZE"):
