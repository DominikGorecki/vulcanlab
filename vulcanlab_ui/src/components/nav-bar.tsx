...
import { LayoutDashboard, Settings, FileText, Eraser, Scissors, Braces, MessageSquare, Database, Zap, FileUp, Trash2, FlaskConical, Search, FolderOpen, Expand } from "lucide-react";
...
const navItems = [
  ...
  { href: "/expansions", label: "Expansions", icon: Expand, alwaysVisible: true },
